...
export default function DevCafePage() {
  const pastEditions = [
    {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-5xl font-bold mb-4">
              <span className="text-primary">devcafé</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-2">Desarrollo de Software</p>
            <p className="text-lg text-muted-foreground text-pretty leading-relaxed">
              Sesiones técnicas de desarrollo de software donde exploramos las últimas tecnologías, frameworks y mejores
              prácticas. Incluye pair programming, code reviews y discusiones sobre arquitectura de software.
            </p>
          </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">Miércoles 22 de Enero 2025</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">18:30 - 21:00 hs</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">Next.js 15 y React 19 - Novedades</div>
                </div>
              </div>
            </div>
            <Button
              size="lg"
              onClick={() => window.open("https://lu.ma/andestech-devcafe", "_blank")}
